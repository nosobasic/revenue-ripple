  ...
  return (
    <div className="admin-layout">
      ...
      <aside className="admin-sidebar">
        <div className="admin-logo">Revenue Ripple Admin</div>
        ...
        {activeTab === "dashboard" && (
          <>
            ...
            {!loading && !dataLoaded && stats.length === 0 && (
              ...
              >
                <p>
                  No data loaded yet. Click "Refresh Data" to load dashboard
                  information.
                </p>
              </div>
            )}
            ...
            >
              ...
              <div>
                <strong>Data Initialized:</strong>{" "}
                {initializationRef.current ? "Yes" : "No"}
              </div>
              <div>
                <strong>Data Loaded:</strong> {dataLoaded ? "Yes" : "No"}
              </div>
              <div>
                <strong>Stats Count:</strong> {stats.length}
              </div>
              <div>
                <strong>Users Count:</strong> {users.length}
              </div>
              <div>
                <strong>Component Loading:</strong> {loading ? "Yes" : "No"}
              </div>
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="user-management">
              ...
              {users.length > 0 ? (
                ...
                >
                  <p>
                    No users loaded. Click "Refresh Users" to load user data.
                  </p>
                </div>
              )}
            </div>
        ...
        {activeTab === "payments" && (
          <>
            ...
            >
              ...
              <p>
                <strong>Webhook Endpoint:</strong> /webhook
              </p>
              <p>
                <strong>Supported Events:</strong> checkout.session.completed
              </p>

              <h4 style={{ marginTop: "24px" }}>Recent Webhooks</h4>
              <p style={{ color: "#666" }}>
                Check server logs for recent webhook activity.
              </p>
            </div>
          </>
        )}
